...
class Payment extends React.Component {
  ...
  getLogData(page) {
    let data2send = this.state.logpay
    data2send['page'] = page || 1
    Api.get('/monitoring/payment', {params: data2send}).then(res => {
      this.setState({
        logs: res.data,
        page: {
  ...
  handleChange(e) {
    let logpay = this.state.logpay
    logpay[e.target.name] = e.target.value
    this.setState({
      logpay: logpay
    })
      ...
      <div className="animated fadeIn">
        <div className="row">
          <div className="col-md-12">
            <div className="card">
              <div className="card-header">Log Payment</div>
